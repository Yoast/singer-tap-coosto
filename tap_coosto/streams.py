...
STREAMS: MappingProxyType = MappingProxyType({
    'intervention_details': {
        'key_properties': 'task_id',
        'replication_method': 'INCREMENTAL',
        'replication_key': 'task_id',
        'bookmark': 'start_date',
        'mapping': {
            'date': {
                'map': 'date', 'type': date_parser, 'null': True,
            },
            'user_id': {
                'map': 'user_id', 'type': int, 'null': False,
            },
            'source': {
                'map': 'source', 'null': False,
            },
            'author': {
                'map': 'author', 'null': False,
            },
            'message': {
                'map': 'message', 'null': False,
            },
            'response': {
                'map': 'response', 'null': False,
            },
            'created': {
                'map': 'created', 'type': date_parser, 'null': False,
            },
            'responsetime': {
                'map': 'responsetime', 'type': int, 'null': False,
            },
            'responsetime_real': {
                'map': 'responsetime_real', 'type': int, 'null': False,
            },
            'url': {
                'map': 'url', 'null': False,
            },
            'task_id': {
                'map': 'task_id', 'type': int, 'null': False,
            },
            'case_id': {
                'map': 'case_id', 'type': int, 'null': True,
            }
        }
    }
})
